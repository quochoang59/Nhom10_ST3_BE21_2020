<?php include "header.php" ?>
  ...
  <div class="content-wrapper">
    ...
    if (isset($_GET['id'])) :
        $id = $_GET['id'];
        $getManufactureById = $manufacture->getManufactureById($id);
        foreach ($getManufactureById as $values) :
    ?>
    <section class="content">
        <form action="editmn.php?id=<?php echo $values['manu_id'] ?>" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12">
